 ...
 * En esta versión adicionaré el sensor de tensión arterial que trabaja a 19200 baudios.
...
//Inicio Variables Tensión Arterial
  int diastolic = 0;
  int systolic = 0;
  int pulseMin = 0;
//Fin Variables Tensión Arterial

void setup()
{
  MySignals.begin();  
  //Serial.begin(9600);
  Serial.begin(19200);    //Sensor SpO2 Oximetria funciona a 2 velocidades: 115200 y 19200.
                          //Los demás sensores: Temperatura Corporal, Frecuencia Respiratoria funcionan a varias.
                          //El sensor de tensión arterial solo funciona a velocidad de 19200 baudios y debido a
                          //esto adacté el sketch para que todos los sensores trabajen a esta velocidad...
  ...
  Serial1.begin(9600);    //Canal Serial de Comunicación: Módulo Bluetooth HC-05.
  Serial2.begin(9600);    //Canal Serial de Comunicación: Módulo FTDI = USB TIPO A MACHO.
  ...
  //Var Tensión o Presión Arterial
    MySignals.initSensorUART();
    MySignals.enableSensorUART(BLOODPRESSURE);
  //Fin Var Tensión Arterial
...
{  
  ...
  while (Serial1.available()>0) 
  {
    ...
    if (serialByte == 'R')
    {
      while(1) 
      {
        ...
        */
        ...
        Serial1.print(",");
        /* Inicio Tension Arterial */
        //Serial1.print(0);                //Tensión Arterial
         Serial1.print(0);                 //Diastolic
         Serial1.print(",");               //Separador
         Serial1.print(0);                 //Systolic
         Serial1.print(",");               //Separador
         Serial1.print(0);                 //Pulse / min
         /* Fin Tensión Arterial */
        Serial1.print(",");
        ...
        /* Inicio Tension Arterial */
        //Serial1.print(0);                //Tensión Arterial
        Serial2.print(0);                 //Diastolic
        Serial2.print(",");               //Separador
        Serial2.print(0);                 //Systolic
        Serial2.print(",");               //Separador
        Serial2.print(0);                 //Pulse / min
         /* Fin Tensión Arterial */
        Serial2.print(",");
    ...
    if (serialByte == 'T')
    {
      while(1) 
      {
        //Begin Tensión o Presión Arterial
        if (MySignals.getStatusBP())
            {
              ...
              if (MySignals.getBloodPressure() == 1)
              {
                ...
                Serial2.println();
                Serial2.print("Diastolic: ");
                Serial2.println(MySignals.bloodPressureData.diastolic);
                Serial2.print("Systolic: ");
                Serial2.println(MySignals.bloodPressureData.systolic);
                Serial2.print("Pulse/min: ");
                Serial2.println(MySignals.bloodPressureData.pulse);
                MySignals.enableMuxUART();   
              }      
              
            }else{
                Serial2.println();
                Serial2.println("Error: Sensor desconectado o apagado."); //Mando Mensaje por Interfaz FTDI. 
                Serial1.print("0");   //Este va ser el comando para enviar a la App via Bluetooth.
                                      //Servirá para que la App muestre un dialogo que informe al usuario que el 
                                      //Sensor esta desconectado de la tarjeta MySignals o apagado.
            }
            //delay(1000);
        //End Tensión o Presión Arterial
