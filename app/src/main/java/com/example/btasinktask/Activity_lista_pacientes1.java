...
public class Activity_lista_pacientes1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewPacientes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(Activity_lista_pacientes1.this);
    ...
    private void confirmacion(){
        ...
        dialogo = new AlertDialog.Builder(Activity_lista_pacientes1.this);
