...
public class SignalMonitorFR2 extends AppCompatActivity implements MiAsyncTask.MiCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (btCurrentState) {
                    ...
                    case (BluetoothAdapter.STATE_ON): {
                        Toast.makeText(SignalMonitorFR2.this, "Bluetooth is ON", Toast.LENGTH_SHORT).show();
                        //AddToListView();
                    ...
                    case (BluetoothAdapter.STATE_OFF): {
                        Toast.makeText(SignalMonitorFR2.this, "Bluetooth is OFF", Toast.LENGTH_SHORT).show();
                        //  bluetooth_ON = false;
                        break;
                    }
                    case (BluetoothAdapter.STATE_CONNECTED): {
                        Toast.makeText(SignalMonitorFR2.this, "Bluetooth is Connected ", Toast.LENGTH_SHORT).show();
                        //checkConnected = true;
                        break;
                    }
                    case (BluetoothAdapter.STATE_DISCONNECTED): {
                        Toast.makeText(SignalMonitorFR2.this, "Bluetooth Disconnected ", Toast.LENGTH_SHORT).show();
        ...
        cb_time.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b){
                    VentanaDialog2(SignalMonitorFR2.this);
                }else{
        ...
        cb_legends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(cb_legends.isChecked()){
                    VentanaDialog1(SignalMonitorFR2.this);
                }else{
                    legendsHidden();
                }
            }
    ...
    */
    ...
    private Runnable mToastRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (contador >= 2) {
                volleyBD.sendInfoServer(SignalMonitorFR2.this,
