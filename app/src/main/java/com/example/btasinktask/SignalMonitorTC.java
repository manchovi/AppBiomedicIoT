...
public class SignalMonitorTC extends AppCompatActivity implements MiAsyncTask.MiCallback{
    ...
    private TextView vd_tc, vd_alarma;
    private CheckBox cb_tc, cb_legends, cb_send, cb_time;
    Switch swDataStream;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signal_monitor_tc);
        ...
        //Toast.makeText(this, "Tempe Set: "+getUmbralSpo2(), Toast.LENGTH_LONG).show();

        //ultimoEstadoCBServer , ultimoEstado
        //ultimoEstadoCBNotificaciones
    ...
    public void VentanaDialog2(final Context context){
        ...
        //ultimoEstadoCBServer, ultimoEstadoCBNotificaciones
        ultimoEstado = obtenerEstadoCbox();
        ultimoEstadoCBNotificaciones = obternerEstadoCboxNotificaciones();
    ...
    void setValueDefaultGraph(){
        ...
        int color1 = this.getResources().getColor(R.color.color_tc);
        dataSeries.setColor(color1);
        //dataSeries.setColor(Color.parseColor("#1a8cff"));

        //Activando leyendas:
        dataSeries.setTitle("Temperatura Corporal");
            ...
            if (estado_sw) {
                if (e) {  //Verifico el estado del checkbox.
                    if (plotCount <= plotlen) {
                        plotValue(plotCount, prev, p.getTemperatura_corporal());  //Aqui sigue mi analisis LUEGO :-(setPlot1(plotCount, prev1, c_Frec_cardiaca);
