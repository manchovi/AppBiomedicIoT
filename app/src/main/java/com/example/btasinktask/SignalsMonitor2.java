...
public class SignalsMonitor2 extends AppCompatActivity implements MiAsyncTask.MiCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cb_time.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b){
                    VentanaDialog2(SignalsMonitor2.this);
                }else{
        ...
        cb_legends.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(cb_legends.isChecked()){
                    ...
                    VentanaDialog1(SignalsMonitor2.this);
                    //estadoCheckBoxLegends.onSetEstadoCheckBoxLegends(false);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        //vd_alarma.setText(i);
                        Toast.makeText(SignalsMonitor2.this, "Fin Thread", Toast.LENGTH_SHORT).show();
                    }
                });
